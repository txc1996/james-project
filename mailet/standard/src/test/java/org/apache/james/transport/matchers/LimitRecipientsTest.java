...
public class LimitRecipientsTest {
    ...
    @Test
    public void matchShouldNotModifyMailsUnderLimit() {
        /*
        Start the matcher with condition = 3

        What happens with a mail with 1 recipients?

        We should return a list of this recipient
         */
    }


    @Test
    public void matchShouldNotModifyMailsAtLimit() {
        /*
        Start the matcher with condition = 3

        What happens with a mail with 3 recipients?

        We should return a list with these 3 recipients
         */
    }
    
    @Test
    public void matchShouldLimitRecipientCountWhenMailsOverLimit() {
        /*
        Start the matcher with condition = 3

        What happens with a mail with 4 recipients?

        We should return a list with the first 3 recipients
         */
    }
